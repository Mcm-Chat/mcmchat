  ...
  public: {
    Tables: {
      ...
      call_log_hides: {
        ...
        Relationships: [
          {
            foreignKeyName: "call_log_hides_call_id_fkey";
            columns: ["call_id"];
            isOneToOne: false;
    ...
    Enums: {
      ...
      chat_order_status:
        ...
        | "delivered"
        | "cancelled";
      contact_request_status: "pending" | "accepted" | "rejected" | "blocked" | "cancelled";
      conversation_type: "direct" | "group" | "business";
      inbox_status: "open" | "pending" | "closed";
      inventory_movement_type: "preparation" | "sale" | "adjustment" | "restock" | "return";
      ledger_status:
        | "pending_approval"
        | "active"
        | "partially_paid"
      ...
      message_kind:
        ...
        | "product_card"
        | "sticker";
      notification_action_kind: "reply" | "read" | "call_answer" | "call_decline";
      ...
      preparation_status:
        "draft" | "sent" | "opened" | "in_progress" | "ready" | "completed" | "cancelled";
      ...
      stock_unit_status:
        "draft" | "available" | "reserved" | "preparing" | "ready" | "delivered" | "void";
      unit_slot_mode: "existing" | "prepare_new";
      unit_slot_status: "pending" | "reserved" | "preparing" | "ready" | "delivered" | "cancelled";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      business_role: ["owner", "admin", "agent", "cashier", "viewer"],
      call_kind: ["audio", "video"],
      call_status: ["ringing", "ongoing", "ended", "missed", "declined", "failed", "unconfigured"],
      chat_order_status: [
        "buyer_requested",
        "seller_confirmed",
        "changes_requested",
