...
import { FolderCog, Package, Plus, Search, ShoppingCart, Store, Trash2 } from "lucide-react";
...
import { CreateBusinessDialog } from "@/components/mcm/business/create-business-dialog";
...
export function CatalogPanel() {
  ...
  if (!biz) return <BusinessHubEmpty userId={userId} />;
  ...
  return (
              ...
              <Dialog open={addOpen} onOpenChange={setAddOpen}>
                ...
                <DialogContent className="max-h-[85vh] overflow-y-auto rounded-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Lengkapi data pembelian pertama (agen, jenis, jumlah, harga modal) agar stok
                      dan indikator laba langsung terhubung.
                    </DialogDescription>
                  </DialogHeader>
    ...
    >
      ...
      <CreateBusinessDialog open={bizOpen} onOpenChange={setBizOpen} userId={userId} />
