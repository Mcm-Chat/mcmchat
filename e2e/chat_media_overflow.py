...
def media_rows(conv, a, b):
    ...
    return [
        ...
        row(kind="ledger",
            body="Piutang " + "Pelanggan Dengan Nama Panjang " * 3 + "Rp12.750.000"),
        row(kind="order", body="Pesanan baru",
            payload={"order_id": str(uuid.uuid4()), "status": "new"}),
        row(kind="product_card", body="Beras Premium",
            payload={
                "productName": "Beras Premium Kemasan Karung Lima Puluh Kilogram Grade A Super",
                "variantName": "Karung 50 kg — kemasan gudang utama",
                "price": 685000, "unit": "karung", "perUnitQty": 50, "perUnitUnit": "kg",
                "stockLabel": "128 karung di Gudang Utama Jalan Panjang Sekali",
                "availableUnitCount": 128, "photos": [],
            }),
        row(kind="sales_card", body="Rincian penjualan",
            payload={
                "number": "INV-2026-000128-GUDANG-UTAMA",
                "total": 4325000, "paid": 2000000, "outstanding": 2325000,
                "paymentMethod": "dp", "note": "Sisa dibayar akhir bulan",
                "items": [
                    {"name": "Beras Premium Kemasan Karung Lima Puluh Kilogram",
                     "variantName": "Karung 50 kg", "unit": "karung",
                     "qty": 5, "price": 685000, "discount": 0, "photos": []},
                    {"name": "Minyak Goreng", "unit": "dus", "qty": 2,
                     "price": 450000, "discount": 25000, "photos": []},
                ],
            }),
